...
public class CameraPipeline extends SentryPipeline {
  ...
  public void run() {
    ...
    try {
      // ref: gst-launch-1.0 nvarguscamerasrc ! 'video/x-raw(memory:NVMM),format=NV12' ! nvvidconv ! 'video/x-raw(memory:NVMM),format=BGRx,width=960,height=540' ! nvvidconv ! xvimagesink
      //@formatter:off
      ...
      // gst-play-1.0 rtsp://rtspProxy:8554/live/HDWebcamC615
      // ffplay -strict -2 rtsp://rtspProxy:8554/live/HDWebcamC615
